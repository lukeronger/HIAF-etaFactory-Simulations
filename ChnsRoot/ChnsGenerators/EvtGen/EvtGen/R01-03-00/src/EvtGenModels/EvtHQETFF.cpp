...
void EvtHQETFF::gettensorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtHQETFF.\n";  
  ::abort();
...
void EvtHQETFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtHQETFF.\n";  
  ::abort();
...
void EvtHQETFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtHQETFF.\n";
  ::abort();
...
void EvtHQETFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtHQETFF.\n";
  ::abort();
