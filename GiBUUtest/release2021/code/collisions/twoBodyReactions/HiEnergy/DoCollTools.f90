...
!!$      call WriteChanges
  ...
  !**************************************************************************
  !****s* CollTools/writePythiaCommons
  ! NAME
  ...
  subroutine writePythiaCommons(iFile)
    ...
    write(iFile,1001) 'MSEL',MSEL

    do i=1,200
       write(iFile,1002) 'MSTU',i,MSTU(i)
    end do
    do i=1,200
       write(iFile,1002) 'MSTJ',i,MSTJ(i)
    end do
    do i=1,200
       write(iFile,1002) 'MSTP',i,MSTP(i)
    end do
    do i=1,200
       write(iFile,1002) 'MSTI',i,MSTI(i)
    end do

    do i=1,200
       write(iFile,1003) 'PARU',i,PARU(i)
    end do
    do i=1,200
       write(iFile,1003) 'PARJ',i,PARJ(i)
    end do
    do i=1,200
       write(iFile,1003) 'PARP',i,PARP(i)
    end do
    do i=1,200
       write(iFile,1003) 'PARI',i,PARI(i)
    end do

    do i=1,200
       write(iFile,1003) 'CKIN',i,CKIN(i)
    end do

 !!$      do i=1,500
 !!$         write(iFile,1004) 'PMAS',i,PMAS(i),PMAS(iPMAS(i),:)
 !!$      end do
 !!$
 !!$      do i=1,500
 !!$         write(iFile,1005) 'MDCY',i,MDCY(i),MDCY(iMDCY(i),1)
 !!$      end do
...
1003 FORMAT ("  ",A,"(",i3,")  "," = ",f14.5)
  ...
  end subroutine writePythiaCommons
