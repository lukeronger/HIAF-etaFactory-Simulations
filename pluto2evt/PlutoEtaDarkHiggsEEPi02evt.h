...
#ifndef PlutoEtaDarkHiggsEEPi02evt_h
#define PlutoEtaDarkHiggsEEPi02evt_h
...
class PlutoEtaDarkHiggsEEPi02evt : public TSelector {
public :
   ...
   PlutoEtaDarkHiggsEEPi02evt(TTree * /*tree*/ =0) { }
   virtual ~PlutoEtaDarkHiggsEEPi02evt() { }
   ...
   ClassDef(PlutoEtaDarkHiggsEEPi02evt,0);

};

#endif

#ifdef PlutoEtaDarkHiggsEEPi02evt_cxx
void PlutoEtaDarkHiggsEEPi02evt::Init(TTree *tree)
{
...
Bool_t PlutoEtaDarkHiggsEEPi02evt::Notify()
{
...
#endif // #ifdef PlutoEtaDarkHiggsEEPi02evt_cxx
