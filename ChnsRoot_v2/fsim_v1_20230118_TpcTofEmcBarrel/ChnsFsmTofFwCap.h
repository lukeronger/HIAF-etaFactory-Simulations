...
//      $Id: FsmTofFwCap.hh,v 1.1 2018/11/16 16:18:00 aida Exp $
//
// Description:
//      Class FsmTofFwCap
//      
...
#ifndef CHNSFSMTOFFWCAP_H
#define CHNSFSMTOFFWCAP_H
...
class ChnsFsmTofFwCap: public ChnsFsmAbsDet
{
public:
  ...
  /** Default ctor. */
  ChnsFsmTofFwCap();
  ChnsFsmTofFwCap(ArgList &par);
  /** Destructor
   */
  virtual ~ChnsFsmTofFwCap();
