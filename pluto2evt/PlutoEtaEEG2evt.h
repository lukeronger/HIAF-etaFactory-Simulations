...
#ifndef PlutoEtaEEG2evt_h
#define PlutoEtaEEG2evt_h
...
class PlutoEtaEEG2evt : public TSelector {
public :
   ...
   PlutoEtaEEG2evt(TTree * /*tree*/ =0) { }
   virtual ~PlutoEtaEEG2evt() { }
   ...
   ClassDef(PlutoEtaEEG2evt,0);

};

#endif

#ifdef PlutoEtaEEG2evt_cxx
void PlutoEtaEEG2evt::Init(TTree *tree)
{
...
#endif // #ifdef PlutoEtaEEG2evt_cxx
