...
// -------------------------------------------------------------------------
// -----                    ChnsFieldPar header file                  -----
// -----                Created 26/03/14  by M. Al-Turany              -----
// -------------------------------------------------------------------------

#ifndef ChnsFieldPar_H
#define ChnsFieldPar_H 1
...
class ChnsFieldPar : public FairParGenericSet
{

  public:
    /** Standard constructor  **/
    ChnsFieldPar(const char* name, const char* title, const char* context);
  ...
  private:
    ...
    ChnsFieldPar(const ChnsFieldPar&);
    ChnsFieldPar& operator=(const ChnsFieldPar&);

    ClassDef(ChnsFieldPar, 1);
};
