{
	...
	TFile *file = new TFile("../../../HIAF-etaFactory-Simulations-localData/pluto6-data/pp_to_ppeta_PipPimPi0_1.8GeV_Random2023.root");
	...
	cout<<"Effi. = "<<(1.0*h->GetEntries()/Ntot/2.0)<<endl;
