{
	...
	h2_Edep_vs_En->Draw("colz");
	gPad->SetLogz();
	h2_Edep_vs_En->SetTitle("");
	h2_Edep_vs_En->GetXaxis()->SetTitle("Kine. energy of n (GeV)");
	h2_Edep_vs_En->GetXaxis()->SetTitleSize(0.06);
	h2_Edep_vs_En->GetXaxis()->CenterTitle();
	...
	h2_Edep_vs_En->GetYaxis()->SetLabelSize(0.06);
	h2_Edep_vs_En->GetYaxis()->SetNdivisions(505);  
	h2_Edep_vs_En->GetZaxis()->SetLabelSize(0.05);


	h2_Edep_vs_En->GetYaxis()->SetRangeUser(0,1.6);    
