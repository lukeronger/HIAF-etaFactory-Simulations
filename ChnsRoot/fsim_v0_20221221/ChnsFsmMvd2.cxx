...
//      $Id: FsmMvd2.cc,v 1.10 2007/05/24 08:07:40 klausg Exp $
//
// Description:
//      Class FsmMvd2
//      
...
ChnsFsmMvd2::ChnsFsmMvd2(ArgList &par) 
{
  initParameters();
...
ChnsFsmResponse* 
ChnsFsmMvd2::respond(ChnsFsmTrack *t)
{
...
bool 
ChnsFsmMvd2::detected(ChnsFsmTrack *t) const
{
  if (t->hitMapValid()) {
...
double 
ChnsFsmMvd2::dp(ChnsFsmTrack *t) const
{
  double p=t->p4().Vect().Mag();
...
double
ChnsFsmMvd2::dphi(ChnsFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
...
double
ChnsFsmMvd2::dtheta(ChnsFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
...
bool
ChnsFsmMvd2::setParameter(std::string &name, double value)
{
  // *****************
...
double ChnsFsmMvd2::MeanEnergyLoss(PidType part) {
...
double ChnsFsmMvd2::LandauGaus(double s_mpv, double widthone, double widthtwo) {
...
double ChnsFsmMvd2::width1(PidType part) {
  double x=_momentum;
  switch(part) {
  case proton:
    if (x>=1.10)
...
double ChnsFsmMvd2::width2(PidType part) {
  double x=_momentum;
  switch(part) {
  case proton:
    if (x>=1.10)
