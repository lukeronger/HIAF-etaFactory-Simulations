{
	...
	hmpi0_3PiChannel->SetTitle("");
	hmpi0_3PiChannel->GetXaxis()->SetTitle("M(#gamma#gamma) / GeV");
	hmpi0_3PiChannel->GetXaxis()->SetTitleSize(0.06);
	hmpi0_3PiChannel->GetXaxis()->CenterTitle();
	hmpi0_3PiChannel->GetXaxis()->SetTitleOffset(1.05);
	hmpi0_3PiChannel->GetXaxis()->SetLabelSize(0.06);
	hmpi0_3PiChannel->GetYaxis()->SetTitle("Counts");
	hmpi0_3PiChannel->GetYaxis()->SetTitleSize(0.06);
	hmpi0_3PiChannel->GetYaxis()->CenterTitle();
	hmpi0_3PiChannel->GetYaxis()->SetTitleOffset(1.05);
	hmpi0_3PiChannel->GetYaxis()->SetLabelSize(0.06);
	hmpi0_3PiChannel->GetZaxis()->SetLabelSize(0.05);

	hmpi0_3PiChannel->GetXaxis()->SetNdivisions(505);
	...
	double Nsignal = model.Integral(xa, xb) / hmpi0_3PiChannel->GetBinWidth(1);
	double Nbg  = bgmodel->Integral(xa, xb) / hmpi0_3PiChannel->GetBinWidth(1);
