{
	...
	cout<<data->Draw("Particles.TLorentzVector.P():Particles.TLorentzVector.Theta()*TMath::RadToDeg()>>h(200,0,180,200,0,5)","Particles.pid==1","colz")<<endl;

	int NEcuts = 3;
	int Nthetacuts = 7;
	double Ecuts[3] = {0.05, 0.1, 5};
	...
	for(int i=3;i<Nthetacuts;i++){
		...
		cout<<"  "<<(NN1=data->Draw("Particles.TLorentzVector.P():Particles.TLorentzVector.Theta()*TMath::RadToDeg()",cut,"colz") )<<endl;
