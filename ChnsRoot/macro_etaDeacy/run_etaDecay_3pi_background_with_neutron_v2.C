...
int run_etaDecay_3pi_background_with_neutron_v2(int nevts=6440000, int seed_num = 2023)
{
  ...
  TString outfile;
  if (outfile=="") {
	outfile="/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/run_fsim_EvtGen_HIAFeta3pideacy_background_with_neutron_"; //1.root";
	outfile+=1.8;
	outfile+="GeV_";
  	outfile+= seed_num;
	outfile+=".root";
