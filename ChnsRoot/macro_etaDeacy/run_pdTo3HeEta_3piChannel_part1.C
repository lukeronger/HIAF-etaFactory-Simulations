...
int run_pdTo3HeEta_3piChannel_part1(int nevts=10000000, int seed_num = 2023)
{
  TString input_file = "/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/pdTo3HeEta_data/pd_to_3He_eta_3piChannel-part4.evt";
  ...
  TString outfile;
  if (outfile=="") {
	outfile="/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/run_fsim_pdTo3HeEta_3piChannel_part4_"; //1.root";
	outfile+=1.8;
	outfile+="GeV_";
  	outfile+= seed_num;
	outfile+=".root";
