...
//      $Id: FsmGemBwCap.cc,v 1.13 2018/11/16 17:42:00 Yutie Liang Exp $
//
// Description:
//      Class FsmGemBwCap
//      
//  Implementation of the GEM BackwardCap for the FastSim
//
...
ChnsFsmGemBwCap::ChnsFsmGemBwCap() 
{
  initParameters();
...
ChnsFsmGemBwCap::ChnsFsmGemBwCap(ArgList &par) 
{
  initParameters();
...
ChnsFsmResponse* 
ChnsFsmGemBwCap::respond(ChnsFsmTrack *t)
{
...
double
ChnsFsmGemBwCap::gauss(double x, double x0, double s)
{
...
double 
ChnsFsmGemBwCap::compdEdx(double p, double M)
{
  double dEdX;
...
bool 
ChnsFsmGemBwCap::detected(ChnsFsmTrack *t) const
{
  if (t->hitMapValid()) {
    return t->hitMapResponse(FsmDetEnum::GemBwCap);
  } else {
...
double 
ChnsFsmGemBwCap::dp(ChnsFsmTrack *t) const
{
...
double
ChnsFsmGemBwCap::dphi(ChnsFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
  return 0.0007; //to be refined
}

double
ChnsFsmGemBwCap::dtheta(ChnsFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
  return 0.0007; //to be refined
}

void
ChnsFsmGemBwCap::print(ostream &o)
{
...
void 
ChnsFsmGemBwCap::initParameters()
{
  _detName         = FsmDetName::name(FsmDetEnum::GemBwCap);
  _n = 11.0;
  _sigXY = 150.0e-6;
  _Bfield = 2.0;
  _Lpath = 0.27;
...
bool
ChnsFsmGemBwCap::setParameter(std::string &name, double value)
{
  // *****************
