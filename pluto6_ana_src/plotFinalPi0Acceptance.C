...
/*
	ofstream f_10_90_005("Pi0_Acc_thetalow10_high90_EThr0.05.txt");
	ofstream f_10_90_01("Pi0_Acc_thetalow10_high90_EThr0.1.txt");
	ofstream f_5_120_005("Pi0_Acc_thetalow5_high120_EThr0.05.txt");
	ofstream f_5_120_01("Pi0_Acc_thetalow5_high120_EThr0.1.txt");
	...
	for(int i=0;i<4;i++){
		...
		f_10_90_005<<Ebeam[i]<<" ";
		f_10_90_005<<data->Draw("g1_theta","g1_theta>10 && g1_theta<90 && g2_theta>10 && g2_theta<90 && g1_P>0.05 && g2_P>0.05")*100.0/NN;
		f_10_90_005<<endl;
		f_10_90_01<<Ebeam[i]<<" ";
		f_10_90_01<<data->Draw("g1_theta","g1_theta>10 && g1_theta<90 && g2_theta>10 && g2_theta<90 && g1_P>0.1 && g2_P>0.1")*100.0/NN;
		f_10_90_01<<endl;

		f_5_120_005<<Ebeam[i]<<" ";
		f_5_120_005<<data->Draw("g1_theta","g1_theta>5 && g1_theta<120 && g2_theta>5 && g2_theta<120 && g1_P>0.05 && g2_P>0.05")*100.0/NN;
		f_5_120_005<<endl;
		f_5_120_01<<Ebeam[i]<<" ";
		f_5_120_01<<data->Draw("g1_theta","g1_theta>5 && g1_theta<120 && g2_theta>5 && g2_theta<120 && g1_P>0.1 && g2_P>0.1")*100.0/NN;
		f_5_120_01<<endl;
...
*/
	...
	TH2F *h = new TH2F("h","",400,1,11,400,0,90);
	h->Draw();
	h->SetTitle("");
	...
	TGraph *g1090_005 = new TGraph("Pi0_Acc_thetalow10_high90_EThr0.05.txt");
	TGraph *g1090_01 =  new TGraph("Pi0_Acc_thetalow10_high90_EThr0.1.txt");
	TGraph *g5120_005 = new TGraph("Pi0_Acc_thetalow5_high120_EThr0.05.txt");
	TGraph *g5120_01 =  new TGraph("Pi0_Acc_thetalow5_high120_EThr0.1.txt");
