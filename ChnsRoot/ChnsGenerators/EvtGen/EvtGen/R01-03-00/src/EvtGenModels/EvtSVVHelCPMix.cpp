...
// for those which were in the antiBs state. Each equation consists of a sum of amplitudes - mod-squaring gives the interference terms.
  ...
  report(EVT_INFO,"EvtGen") << "00: " << amplSum00 << std::endl;  
  amp.vertex(0,1,amplSum01);
  report(EVT_INFO,"EvtGen") << "01: " << amplSum01 << std::endl;
  amp.vertex(0,2,amplSum02);
  report(EVT_INFO,"EvtGen") << "02: " << amplSum02 << std::endl;

  amp.vertex(1,0,amplSum10);
  report(EVT_INFO,"EvtGen") << "10: " << amplSum10 << std::endl;
  amp.vertex(1,1,amplSum11);
  report(EVT_INFO,"EvtGen") << "11: " << amplSum11 << std::endl;
  amp.vertex(1,2,amplSum12);
  report(EVT_INFO,"EvtGen") << "12: " << amplSum12 << std::endl;

  amp.vertex(2,0,amplSum20);
  report(EVT_INFO,"EvtGen") << "20: " << amplSum20 << std::endl;
  amp.vertex(2,1,amplSum21);
  report(EVT_INFO,"EvtGen") << "21: " << amplSum21 << std::endl;
  amp.vertex(2,2,amplSum22);
  report(EVT_INFO,"EvtGen") << "22: " << amplSum22 << std::endl;
