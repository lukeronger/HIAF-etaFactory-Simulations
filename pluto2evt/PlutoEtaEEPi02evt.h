...
#ifndef PlutoEtaEEPi02evt_h
#define PlutoEtaEEPi02evt_h
...
class PlutoEtaEEPi02evt : public TSelector {
public :
   ...
   PlutoEtaEEPi02evt(TTree * /*tree*/ =0) { }
   virtual ~PlutoEtaEEPi02evt() { }
   ...
   ClassDef(PlutoEtaEEPi02evt,0);

};

#endif

#ifdef PlutoEtaEEPi02evt_cxx
void PlutoEtaEEPi02evt::Init(TTree *tree)
{
...
Bool_t PlutoEtaEEPi02evt::Notify()
{
...
#endif // #ifdef PlutoEtaEEPi02evt_cxx
