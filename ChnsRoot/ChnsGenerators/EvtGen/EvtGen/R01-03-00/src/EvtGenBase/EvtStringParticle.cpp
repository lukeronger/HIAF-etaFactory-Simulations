...
EvtSpinDensity EvtStringParticle::rotateToHelicityBasis() const{
  ...
  report(EVT_ERROR,"EvtGen") << "rotateToHelicityBasis not implemented for strin particle."; 
...
EvtSpinDensity EvtStringParticle::rotateToHelicityBasis(double,
  ...
  report(EVT_ERROR,"EvtGen") << "rotateToHelicityBasis(alpha,beta,gamma) not implemented for string particle."; 
  report(EVT_ERROR,"EvtGen") << "Will terminate execution."; 
