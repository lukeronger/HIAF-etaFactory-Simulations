 ...
 ********************************************************************************/
#ifndef CHNSTOFPOINT_H
#define CHNSTOFPOINT_H 1
...
class ChnsTofPoint : public FairMCPoint
{
  ...
  private:
    /** Copy constructor **/
    ChnsTofPoint(const ChnsTofPoint& point);
    ChnsTofPoint operator=(const ChnsTofPoint& point);

    ClassDef(ChnsTofPoint, 1);
};
