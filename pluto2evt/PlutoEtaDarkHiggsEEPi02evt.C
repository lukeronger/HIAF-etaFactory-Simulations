#define PlutoEtaDarkHiggsEEPi02evt_cxx
// The class definition in PlutoEtaDarkHiggsEEPi02evt.h has been generated automatically
...
//
// root> T->Process("PlutoEtaDarkHiggsEEPi02evt.C")
// root> T->Process("PlutoEtaDarkHiggsEEPi02evt.C","some options")
// root> T->Process("PlutoEtaDarkHiggsEEPi02evt.C+")
//
...
#include "PlutoEtaDarkHiggsEEPi02evt.h"
#include <TH2.h>
#include <TStyle.h>
#include "TString.h"

void PlutoEtaDarkHiggsEEPi02evt::Begin(TTree * /*tree*/)
{
   ...
   TString filename = Form("pp_to_ppeta_EEPi0_mDarkHiggs%lg_1.8GeV_Random2023.root.evt", mDarkHiggs);
   filename = "/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/Pluto6-evt/" + filename;
   evtout.open(filename.Data());
}


void PlutoEtaDarkHiggsEEPi02evt::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t PlutoEtaDarkHiggsEEPi02evt::Process(Long64_t entry)
{
...
void PlutoEtaDarkHiggsEEPi02evt::SlaveTerminate()
{
...
void PlutoEtaDarkHiggsEEPi02evt::Terminate()
{
