...
module histMC
  ...
  public :: CopyDesc
  public :: AddHistMC
  public :: WriteHeaderMC
  public :: WriteHistMC
  public :: WriteHistMC_Integrated
  public :: WriteHistMC_Gauss
  public :: ReadHistMC
  public :: FetchHistMC
  public :: sumHistMC
  public :: rebinHistMC
...
contains
  ...
  ! PURPOSE
  ! Perform a rebinning of a present histogram, i.e. increase the bin size by
  ! an integer factor.
  ! INPUTS
  ...
  !
  ! Output of "Underflow","Entries","Overflow" shows only the sum of all
  ! channels.
  !
  ! INPUTS
  ...
  ! * type(histogram) :: H     -- Histogramm to be used
  ! * character*(*)   :: file  -- name of file to open and close
  ! * logical         :: div   -- if true, divide data by bin width [OPTIONAL]
  ! OUTPUT
  ! write to file
  !****************************************************************************
  subroutine WriteHistMC_Integrated(H,file,div)
