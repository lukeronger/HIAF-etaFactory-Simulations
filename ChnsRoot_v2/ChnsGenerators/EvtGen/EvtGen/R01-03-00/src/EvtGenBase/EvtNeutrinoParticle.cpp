...
void EvtNeutrinoParticle::init(EvtId part_n,const EvtVector4R& p4){
  ...
  if (EvtPDL::getStdHep(part_n)==0){
    report(EVT_ERROR,"EvtGen") << "Error in EvtNeutrinoParticle::init, part_n="
			   << part_n.getId()<<endl;
  }
...
EvtDiracSpinor EvtNeutrinoParticle::spNeutrino() const {
  ...
  report(EVT_ERROR,"EvtGen") << "Tried to get neutrino spinor in restframe"; 
...
EvtSpinDensity EvtNeutrinoParticle::rotateToHelicityBasis() const{
  ...
  report(EVT_ERROR,"EvtGen") << "rotateToHelicityBasis not implemented for neutrino."; 
  report(EVT_ERROR,"EvtGen") << "Will terminate execution."; 
...
EvtSpinDensity EvtNeutrinoParticle::rotateToHelicityBasis(double,
  ...
  report(EVT_ERROR,"EvtGen") << "rotateToHelicityBasis(alpha,beta,gama) not implemented for neutrino."; 
  report(EVT_ERROR,"EvtGen") << "Will terminate execution."; 
