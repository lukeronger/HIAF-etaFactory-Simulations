...
!  integer, parameter :: nPart=15
  ...
  logical, parameter :: respectHad = .TRUE.
...
!       form1 = Q2_**2/((Q2_+0.78**2)**2)*(1-Q2_/(2*0.938*nu_))
       ...
       do iEv=1,nEv
          call DoColl_nuN_Py(eNev1,outPart_DIS,flagOK,XS1,respectHad)
          sum1=sum1+XS1
       enddo
...
!       form2 = Q2_**2/((Q2_+0.78**2)**2)*(1-Q2_/(2*0.938*nu_))
       ...
       do iEv=1,nEv
          call DoColl_nuN_Py(eNev2,outPart_DIS,flagOK,XS2,respectHad)
          sum2=sum2+XS2
       enddo
...
!       do iEv=1,nEv
!          call DoColl_nuN_Py(eNev2,outPart_DIS,flagOK,XS2)
    call DoColl_nuN_Py(eNev2,outPart_DIS,flagOK,XS2,respectHad)
