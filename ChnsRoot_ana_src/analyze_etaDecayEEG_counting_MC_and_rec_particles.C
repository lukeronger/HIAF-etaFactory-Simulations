...
void analyze_etaDecayEEG_counting_MC_and_rec_particles()
{

	int total_EEGDecay_events = 10000000; 
	...
	/// The output file:
	TString output_file = "../../HIAF-etaFactory-Simulations-localData/ChnsRoot-data/hiaf-etaDecay-EEG-MC-and-rec-results.root";
	...
	TH1D * hmeta = new TH1D("hmeta","m_{#eta}",600,0,2);
	TH1D * hmeta_MC = new TH1D("hmeta_MC","m_{#eta}",600,0,2);
	TH1D * hmeta_2 = new TH1D("hmeta_2","",600,0,2);
