...
ChnsPidCandidate::ChnsPidCandidate(): FairRecoCandidate(),
  fLocked(kFALSE),
  fCharge(0),
  fPdgCode(0),
  fXposition(0.),		
  ...
  fMvdDEDX(0.),
  fMvdHits(0),
  fMvdDCA(0.),  //DCA in track level; yutie 0328
  fTpcMeanDEDX(0.),
  fTpcHits(0),
  fSttMeanDEDX(0.),
  fSttHits(0),
...
ChnsPidCandidate::ChnsPidCandidate(Int_t charge, TVector3 &pos, TLorentzVector &p4, TMatrixD &cov7 ) : FairRecoCandidate(),
  fLocked(kFALSE),
  fCharge(0),
  fPdgCode(0),
  fXposition(0.),		
...
ChnsPidCandidate::ChnsPidCandidate(Int_t charge, TVector3 &pos, TLorentzVector &p4) : FairRecoCandidate(),
  fLocked(kFALSE),
  fCharge(0),
  fPdgCode(0),
  fXposition(0.),		
...
ChnsPidCandidate::~ChnsPidCandidate()
{
}

TMatrixD& ChnsPidCandidate::Cov7() const
{
...
TMatrixD& ChnsPidCandidate::P4Cov() const
{
...
void ChnsPidCandidate::SetLorentzVector(TLorentzVector &p4)
{
  fXmomentum = p4.X();
  fYmomentum = p4.Y();
  fZmomentum = p4.Z();
...
void ChnsPidCandidate::SetCov7(const TMatrixD &cov7 )
{
  // position error
...
void ChnsPidCandidate::SetP4Cov(const TMatrixD &covP4 )
{
  // position error
...
void ChnsPidCandidate::SetDefault()
{
  fLocked = kFALSE;
  fCharge = 0;
  fPdgCode = 0;
