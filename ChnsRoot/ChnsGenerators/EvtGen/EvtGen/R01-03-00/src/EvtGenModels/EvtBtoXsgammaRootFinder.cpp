...
EvtBtoXsgammaRootFinder::GetRootSingleFunc(const EvtItgAbsFunction* theFunc, double functionValue, double lowerValue, double upperValue, double precision) {
  ...
  if ( f1*f2 > 0.0 ) {
    report(EVT_WARNING,"EvtGen") << "EvtBtoXsgammaRootFinder: No root in specified range !"<<endl;  
    return 0;
  }
  ...
  report(EVT_WARNING,"EvtGen") << "EvtBtoXsgammaRootFinder: Maximum number of iterations "
