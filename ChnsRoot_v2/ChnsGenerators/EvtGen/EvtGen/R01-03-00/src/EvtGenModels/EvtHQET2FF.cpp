...
void EvtHQET2FF::gettensorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtHQET2FF.\n";  
  ::abort();
...
void EvtHQET2FF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtHQET2FF.\n";  
  ::abort();
...
void EvtHQET2FF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtHQET2FF.\n";
  ::abort();
...
void EvtHQET2FF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtHQET2FF.\n";
  ::abort();
