#ifndef CHNSANALYSIS_H
#define CHNSANALYSIS_H 1
...
class ChnsAnaPidSelector;
class ChnsAnaPidCombiner;
class ChnsMCTrack;
//class ChnsEventInfo;
...
{
  public:
    ChnsAnalysis(TString tname1="", TString tname2="",TString algnamec="PidAlgoIdealCharged", TString algnamen="PidAlgoIdealNeutral");
    virtual ~ChnsAnalysis();
  ...
  private:
    ...
    ChnsAnaPidSelector* fPidSelector;
    ChnsAnaPidCombiner* fPidCombiner;
    Int_t              fEvtCount;
    Int_t              fChainEntries;
    Bool_t             fEventRead;
