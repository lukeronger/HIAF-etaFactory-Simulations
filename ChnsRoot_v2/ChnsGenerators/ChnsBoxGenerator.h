 ...
 *
 * The ChnsBoxGenerator generates particles within given range
 * over pt, phi, eta, y or theta a fixed multiplicity per event.
 * Derived from FairGenerator.
**/

/* $Id: ChnsBoxGenerator.h,v 1.3 2006/07/14 11:23:57 kharlov Exp $ */

/* History of cvs commits:
 *
 * $Log: ChnsBoxGenerator.h,v $
...
class ChnsBoxGenerator : public FairGenerator
{
  public:
     ...
     **/
    ChnsBoxGenerator(Int_t pdgid, Int_t mult=1);

    /** Destructor **/
    virtual ~ChnsBoxGenerator() {};
  ...
  protected:
    /** Copy constructor. **/
    ChnsBoxGenerator(const ChnsBoxGenerator&);
    ChnsBoxGenerator& operator=(const ChnsBoxGenerator&);
  ...
  private:
    ...
    int count_ionadded; // this is for ions added, in addition to the default p/d/t/n/He3/He4/e/gamma

    ClassDef(ChnsBoxGenerator,4);
