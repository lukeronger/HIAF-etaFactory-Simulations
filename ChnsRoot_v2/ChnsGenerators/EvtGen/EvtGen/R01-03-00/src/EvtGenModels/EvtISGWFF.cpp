...
void EvtISGWFF::EvtISGW1FF3P2 (EvtId parent,EvtId daugt,
  ...
  if (parent==BM||parent==BP||parent==B0||parent==B0B) { 
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_3P1.\n";
      }
    }
  }
  else{
...
void EvtISGWFF::EvtISGW1FF1S0 ( EvtId parent, EvtId daugt,
  ...
  if (parent==BM||parent==BP||parent==B0||parent==B0B) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_1S0.\n";
      }
    }
  }
  else{
...
void  EvtISGWFF::EvtISGW1FF3S1(EvtId parent,EvtId daugt,double t,
  ...
  if (parent==BM||parent==BP||parent==B0||parent==B0B) { 
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_3S1.\n";
      }
    }
  }
  else{
    report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_3S1.\n";
  }
...
void EvtISGWFF::EvtISGW1FF3P0 (EvtId parent,EvtId daugt,
  ...
  if (parent==BM||parent==BP||parent==B0||parent==B0B) {    
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_3P0.\n";
      }
    }
  }
  else{
    report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_3P0.\n";
  }
...
void EvtISGWFF::EvtISGW1FF21S0 (EvtId parent,EvtId daugt,
  ...
  if (parent==BM||parent==BP||parent==B0||parent==B0B) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw1_ff_21S0.\n";
      }
    }
  }
  else{
    report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw1_ff_21S0.\n";
  }
...
void EvtISGWFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtISGWFF.\n";  
  ::abort();
...
void EvtISGWFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtISGWFF.\n";
  ::abort();
...
void EvtISGWFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtISGWFF.\n";
  ::abort();
