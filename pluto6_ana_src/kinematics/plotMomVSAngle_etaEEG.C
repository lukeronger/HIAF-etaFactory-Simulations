{
	...
	c1.cd(1);
	data->Draw("Particles.TLorentzVector.P():Particles.TLorentzVector.Theta()*TMath::RadToDeg()>>h(100,0,180, 100,0,1.4)","Particles.pid==3","colz",2000000);
	gPad->SetLogz();
	h->SetTitle("");
	...
	c1.cd(2);
	data->Draw("Particles.TLorentzVector.P():Particles.TLorentzVector.Theta()*TMath::RadToDeg()>>h2(100,0,180, 100,0,1.4)","Particles.pid==1","colz",2000000);
	gPad->SetLogz();
	h2->SetTitle("");
	...
	c1.cd(3);
	data->Draw("Particles.TLorentzVector.Pt():Particles.TLorentzVector.Theta()*TMath::RadToDeg()>>h3(100,0,180, 100,0,1)","Particles.pid==3","colz",2000000);
	gPad->SetLogz();
	h3->SetTitle("");
