{
	...
	TLine * li = new TLine(10,0.1, 150,0.1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
	li = new TLine(10,1,150,1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
	li = new TLine(10,0.1,10,1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
	li = new TLine(90,0.1,90,1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
	li = new TLine(100,0.1,100,1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
	li = new TLine(120,0.1,120,1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
	li = new TLine(150,0.1,150,1);
	li->SetLineWidth(1);
	li->SetLineColor(2);
	li->Draw();
