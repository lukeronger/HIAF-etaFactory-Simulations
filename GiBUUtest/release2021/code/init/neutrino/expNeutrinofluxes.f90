...
module expNeutrinofluxes
  ...
  public :: MINOSenergyNU_fluxBARNU, MINOSenergyBARNU_fluxBARNU
  public :: uniformFlux
...
!!$          end select
  ...
  ! NAME
  ! real function DUNEenergyNU(flavor_id,process_id)
  !
  ! PURPOSE
  ...
  real function DUNEenergyNU(Flavor_ID,Process_ID)
    ...
    integer, save :: jmax
    integer :: nswitch
    integer, intent(in) :: flavor_id,process_id
  ...
  ! NAME
  ! real function DUNEenergyBARNU(flavor_id,process_id)
  !
  ! PURPOSE
