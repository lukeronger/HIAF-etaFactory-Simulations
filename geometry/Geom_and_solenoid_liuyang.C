...
void Geom_and_solenoid_liuyang(){
...
//	CHNS->AddNode(cylinder,1);
	...
	for(int i=0;i<5;i++){
        ...
        for(int i=0;i<5;i++){
                ...
                cylinder1->SetLineColor(kBlue - 7);
