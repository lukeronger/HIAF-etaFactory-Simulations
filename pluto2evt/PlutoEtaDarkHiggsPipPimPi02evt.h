...
#ifndef PlutoEtaDarkHiggsPipPimPi02evt_h
#define PlutoEtaDarkHiggsPipPimPi02evt_h
...
class PlutoEtaDarkHiggsPipPimPi02evt : public TSelector {
public :
   ...
   TRandom3 *random3;
   double mDarkHiggs = 0.1;

   PlutoEtaDarkHiggsPipPimPi02evt(TTree * /*tree*/ =0) { }
   virtual ~PlutoEtaDarkHiggsPipPimPi02evt() { }
   ...
   ClassDef(PlutoEtaDarkHiggsPipPimPi02evt,0);

};

#endif

#ifdef PlutoEtaDarkHiggsPipPimPi02evt_cxx
void PlutoEtaDarkHiggsPipPimPi02evt::Init(TTree *tree)
{
...
Bool_t PlutoEtaDarkHiggsPipPimPi02evt::Notify()
{
...
#endif // #ifdef PlutoEtaDarkHiggsPipPimPi02evt_cxx
