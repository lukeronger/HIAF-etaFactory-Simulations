void run_fsim_H3L(Int_t nEvents = 10000, int seed_num=1000)
{
  ...
  TString outfile;
  if (outfile=="") {
  outfile="./output/run_fsim_H3L"; //1.root";
    outfile+= nEvents;
  outfile+=".root";
  }
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	...
	ChnsBoxGenerator* boxGen1 = new ChnsBoxGenerator(1010010030, 1); // 1010010030 = H3L; 1 = multipl.
	boxGen1->SetPtRange(0.1, 4); // GeV/c
	boxGen1->SetYRange(-0.5, 3.20); // Rapidity
