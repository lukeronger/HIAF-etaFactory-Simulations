...
\item {\bf src/utilities/ } - source code for utilities.\\
  ...
  \end{itemize}   
\item {\bf src/photos-fortran/ } - the  standard {\tt PHOTOS FORTRAN} 
...
will take precedence.  {\bf ZBW: need to be checked}.}.
...
releases. 
{\bf On-going work, in particular on interference correction and pair emission ... (ref: http://annapurna.ifj.edu.pl/~wasm/pairs.pdf and http://annapurna.ifj.edu.pl/~wasm/ifi.pdf). The precision level described in this work goes down from 0.5\% to 0.2\% for LHC applications and $Z$, $W$ decays. }
...
\subsection*{Testing}
\begin{itemize}
  \item[\ding{111}]{\bf 3} - event record options
