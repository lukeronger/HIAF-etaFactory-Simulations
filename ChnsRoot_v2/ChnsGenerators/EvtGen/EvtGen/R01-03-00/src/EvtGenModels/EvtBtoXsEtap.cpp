...
void EvtBtoXsEtap::decay( EvtParticle *p ){
  ...
  //  report(EVT_DEBUG,"EvtGen") << "In EvtBtoXsEtap: X_s daughters should not be here!"<<endl;
  //  return;
  //}
  ...
  if ((Xscode == 30343) || (Xscode == -30343) || 
    ...
    report(EVT_DEBUG,"EvtGen") << "In EvtBtoXsEtap: Particle with id " << Xscode << " is not a Xsd/u particle"<<endl;
    return;
  }
  ...
  // debug stuff:  report(EVT_INFO,"EvtGen") << "Xscode " << Xscode << " daughter 1 mass " << mass[0] << " daughter 2 mass " << mass[1] << endl;
