...
double EvtPFermi::getSFBLNP(const double &what)
{
  ...
  report(EVT_ERROR,"EvtGen") << "The tgamma function is not available on this platform\n";
  report(EVT_ERROR,"EvtGen") <<"Presumably, you are getting the wrong answer, so I abort..";
  ::abort();
#else
