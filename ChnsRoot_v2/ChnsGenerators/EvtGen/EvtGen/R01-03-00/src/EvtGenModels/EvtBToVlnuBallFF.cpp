...
void EvtBToVlnuBallFF::getscalarff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtBToVlnuBallFF.\n";  
  ::abort();
...
void EvtBToVlnuBallFF::gettensorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtBToVlnuBallFF.\n";  
  ::abort();
...
void EvtBToVlnuBallFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtBToVlnuBallFF.\n";  
  ::abort();
...
void EvtBToVlnuBallFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtBToVlnuBallFF.\n";
  ::abort();
...
void EvtBToVlnuBallFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtBToVlnuBallFF.\n";
  ::abort();
