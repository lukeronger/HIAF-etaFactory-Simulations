...
ChnsFsmEmcFwCap::ChnsFsmEmcFwCap()
{
  initParameters();
...
ChnsFsmEmcFwCap::ChnsFsmEmcFwCap(ArgList &par)
{
  initParameters();
...
ChnsFsmResponse*
ChnsFsmEmcFwCap::respond(ChnsFsmTrack *t)
{
...
bool
ChnsFsmEmcFwCap::detected(ChnsFsmTrack *t) const
{
  if (t->hitMapValid()) {
...
double
ChnsFsmEmcFwCap::dE(ChnsFsmTrack *t) const
{
  double E = t->p4().E();
...
double
ChnsFsmEmcFwCap::dphi(ChnsFsmTrack *t) const
{
...
double
ChnsFsmEmcFwCap::dtheta(ChnsFsmTrack *t) const
{
  double theta = t->p4().Vect().Theta();
...
double
ChnsFsmEmcFwCap::gauss(double x, double x0, double s)
{
...
double
ChnsFsmEmcFwCap::compdepE(double E, double pdgcode)
{
...
void
ChnsFsmEmcFwCap::print(ostream &o)
{
...
void
ChnsFsmEmcFwCap::initParameters()
{
  _detName = "EmcFwCap";
...
bool
ChnsFsmEmcFwCap::setParameter(std::string &name, double value)
{
  // *****************
