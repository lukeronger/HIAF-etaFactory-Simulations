...
void EvtMelikhovFF::getscalarff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtMelikhovFF.\n";  
  ::abort();
...
void EvtMelikhovFF::gettensorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtMelikhovFF.\n";  
  ::abort();
...
void EvtMelikhovFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtMelikhovFF.\n";  
  ::abort();
...
void EvtMelikhovFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtMelikhovFF.\n";
  ::abort();
...
void EvtMelikhovFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtMelikhovFF.\n";
  ::abort();
