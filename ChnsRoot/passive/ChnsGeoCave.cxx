...
using namespace std;
ClassImp(ChnsGeoCave);

ChnsGeoCave::ChnsGeoCave()
    : FairGeoSet()
    , name("cave")
{
    // Constructor
...
Bool_t ChnsGeoCave::read(fstream& fin, FairGeoMedia* media)
{
...
void ChnsGeoCave::write(fstream& fout)
{
