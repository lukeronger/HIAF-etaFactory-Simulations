...
ChnsConstField::ChnsConstField(const char* name,
                           Double_t xMin,
                           Double_t xMax,
                           Double_t yMin,
                           Double_t yMax,
...
ChnsConstField::ChnsConstField(ChnsFieldPar* fieldPar)
    : FairField()
    , fXmin(0.)
    , fXmax(0.)
    , fYmin(0.)
...
{
    if (!fieldPar) {
        cerr << "-W- ChnsConstField::ChnsConstField: empty parameter container!" << endl;
        fType = 0;
    } else {
...
// -----   Set field region   ----------------------------------------------
void ChnsConstField::SetFieldRegion(Double_t xMin,
                                  Double_t xMax,
                                  Double_t yMin,
                                  Double_t yMax,
                                  Double_t zMin,
...
// -----   Set field values   ----------------------------------------------
void ChnsConstField::SetField(Double_t bX, Double_t bY, Double_t bZ)
{
    fBx = bX;
    fBy = bY;
    fBz = bZ;
...
Double_t ChnsConstField::GetBx(Double_t x, Double_t y, Double_t z)
{
...
Double_t ChnsConstField::GetBy(Double_t x, Double_t y, Double_t z)
{
    if (x < fXmin || x > fXmax || y < fYmin || y > fYmax || z < fZmin || z > fZmax)
        return 0.;
    return fBy;
...
Double_t ChnsConstField::GetBz(Double_t x, Double_t y, Double_t z)
{
    if (x < fXmin || x > fXmax || y < fYmin || y > fYmax || z < fZmin || z > fZmax)
        return 0.;
    return fBz;
