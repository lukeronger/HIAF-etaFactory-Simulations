...
TCanvas *CreateCanvas_for_1Times2Pads_noseparation(int xsize=640, int ysize=590, string name=" ", string title=" "){
	double lmargin = 0.145;
	double bmargin = 0.166;
	double tmargin = 0.04;
	double rmargin = 0.0;
	TCanvas *c1;
	if(name != " ") c1 = new TCanvas(name.c_str(),title.c_str(),xsize,ysize);
...
TH2F *CreateFrame_for_1Times2Pads_noseparation(double xmin=0, double xmax=2, double ymin=0, double ymax=10, string xtitle="x", string ytitle="y", string name=" ", string title=" "){
	TH2F *hframe;
	if(name != " ") hframe = new TH2F(name.c_str(),title.c_str(),400,xmin,xmax,400,ymin,ymax);
	else {
		hframe = new TH2F(Form("h2_%d",nframe),title.c_str(),400,xmin,xmax,400,ymin,ymax);
...
TH2F *CreateFrame_for_1Times2Pads_noseparation_bottom(double xmin=0, double xmax=2, double ymin=0, double ymax=10, string xtitle="x", string ytitle="y", string name=" ", string title=" "){
	TH2F *hframe;
	if(name != " ") hframe = new TH2F(name.c_str(),title.c_str(),400,xmin,xmax,400,ymin,ymax);
	else {
		hframe = new TH2F(Form("h2_%d",nframe),title.c_str(),400,xmin,xmax,400,ymin,ymax);
	...
	hframe->Draw();
        hframe->GetXaxis()->SetTitle(xtitle.c_str());
	hframe->GetXaxis()->SetTitleSize(0.09);
	hframe->GetXaxis()->CenterTitle();
	hframe->GetXaxis()->SetTitleOffset(0.9);
	hframe->GetXaxis()->SetLabelSize(0.09);
	hframe->GetXaxis()->SetNdivisions(505);
	hframe->GetYaxis()->SetTitle(ytitle.c_str());
	hframe->GetYaxis()->SetTitleSize(0.09);
	hframe->GetYaxis()->CenterTitle();
	hframe->GetYaxis()->SetTitleOffset(0.75);
	hframe->GetYaxis()->SetLabelSize(0.09);
	hframe->GetYaxis()->SetNdivisions(505);
	hframe->GetZaxis()->SetLabelSize(0.06);
	return hframe;
}
...
TCanvas *CreateCanvas_for_1Times2Pads(int xsize=640, int ysize=590, string name=" ", string title=" "){
	double lmargin = 0.12;
	double bmargin = 0.16;
	double tmargin = 0.03;
	double rmargin = 0.05;
...
TH2F *CreateFrame_for_1Times2Pads(double xmin=0, double xmax=2, double ymin=0, double ymax=10, string xtitle="x", string ytitle="y", string name=" ", string title=" "){
	TH2F *hframe;
	if(name != " ") hframe = new TH2F(name.c_str(),title.c_str(),400,xmin,xmax,400,ymin,ymax);
	else {
		hframe = new TH2F(Form("h2_%d",nframe),title.c_str(),400,xmin,xmax,400,ymin,ymax);
