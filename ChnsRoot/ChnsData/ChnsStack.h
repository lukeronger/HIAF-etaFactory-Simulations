 ...
 ** are copied to a ChnsMCTrack array, which is stored in the output.
 **
...
class ChnsStack : public FairGenericStack
{
  ...
  public:
    ...
    virtual FairGenericStack* CloneStack() const { return new ChnsStack(*this); }
  ...
  private:
    ...
    ChnsStack(const ChnsStack&);
    ChnsStack& operator=(const ChnsStack&);

    ClassDef(ChnsStack, 1);
};
