...
void EvtISGW2FF::EvtISGW2FF1S0 (EvtId parent,EvtId daugt,
  ...
  if (theB.contains(prnt)) {
	...
	nfp = 3.0;
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented daugt:"<<daugt.getId()<<" in get_isgw_ff_1S0.\n";
      }
    }
  }
  else{
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_1S0.\n";
	report(EVT_ERROR,"EvtGen") << "Parent:"<<parent.getId()<<endl;
      }
    }
    }
  }
...
//  report(EVT_ERROR,"EvtGen") << "before w\n";
...
void  EvtISGW2FF::EvtISGW2FF3S1(EvtId parent,EvtId daugt,double t,double mass,
  ...
  if (parent==B0||parent==B0B||parent==BP||parent==BM) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt:"<<daugt.getId()<<" in get_isgw_ff_3S1.\n";
      }
    }
  }
  else{
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw2_ff_3S1.\n";
      }
    }
    }
  }
...
void EvtISGW2FF::EvtISGW2FF21S0 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	nfp=3.0;
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_EvtISGW2_ff_21S0.\n";
      }
    }
  }
  else{
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_EvtISGW2_ff_21S0.\n";
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_EvtISGW2_ff_21S0.\n";
    }
  }
...
void EvtISGW2FF::EvtISGW2FF23S1 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	nfp=3.0;
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_23P1.\n";
      }
    }
  }
  else{
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_23P1.\n";
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_23P1.\n";
    }
  }
...
void EvtISGW2FF::EvtISGW2FF1P1 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_1P1.\n";
      }
    }
  }
  else{
	...
	if  (dgt==D1P1SP||dgt==D1P1SN) {
	  ...
	  nfp = 2.0;
	    ...
	    report(EVT_ERROR,"EvtGen") << "Not implemented daugt:"
                         <<daugt.getId()<<" in get_isgw_ff_1S0.\n";
	}
      }
    
    else{
      report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_1P1.\n";
    }
    }
  }
...
void EvtISGW2FF::EvtISGW2FF3P1 (EvtId parent,EvtId daugt, 
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt:"<<daugt.getId()<<" in get_isgw_ff_3P1.\n";
      }
    }
  }
  else{
	...
	if  (dgt==D3P1SP||dgt==D3P1SN) {
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_3P1.\n";
    }
    }
  }
...
void EvtISGW2FF::EvtISGW2FF3P0 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_EvtISGW2_ff_3P0.\n";
      }
    }
  }
  else{
	...
	if (prnt==BS0||prnt==BSB){
	  ...
	  report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_EvtISGW2_ff_3P0.\n";
	}
      }
    }
  }
...
void EvtISGW2FF::EvtISGW2FF3P2 (EvtId parent,EvtId daugt,
  ...
  if (prnt==B0||prnt==B0B||prnt==BP||prnt==BM) {
	...
	report(EVT_ERROR,"EvtGen") << "Not implemented daugt in get_isgw_ff_3P2.\n";
      }
    }
  }
  else{
	...
	if  (dgt==D3P2SP||dgt==D3P2SN) {
      ...
      report(EVT_ERROR,"EvtGen") << "Not implemented parent in get_isgw_ff_3P2.\n";
    }
    }
  }
  mtb = msb + msd;
...
void EvtISGW2FF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtISGW2FF.\n";  
...
void EvtISGW2FF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtISGW2FF.\n";
  ::abort();
...
void EvtISGW2FF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtISGW2FF.\n";
  ::abort();
