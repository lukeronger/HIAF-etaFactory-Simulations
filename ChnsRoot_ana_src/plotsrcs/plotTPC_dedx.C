{
	...
	chain->Draw("PidChargedCand.fTpcMeanDEDX:sqrt(pow(PidChargedCand.fEnergy,2) - 0.139*0.139) >>hpip(200,0,1,500,0,30)","","colz");
	hpip->Draw("col");
	hpip->SetTitle("");
	...
	hpip->GetYaxis()->SetTitle("MeanDEDX");
	...
	double y_maximum = 25;    //0.5  * hpip->GetMaximum();
	TLatex *tex = new TLatex(0.6, y_maximum, "Silicon Pixel");
