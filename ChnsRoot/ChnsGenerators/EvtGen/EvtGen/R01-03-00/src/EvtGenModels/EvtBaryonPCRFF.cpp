...
void EvtBaryonPCRFF::getscalarff(EvtId, EvtId, double, double, double*, double*) {
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getscalarff in EvtBaryonPCRFF.\n";  
  ::abort();
...
void EvtBaryonPCRFF::getvectorff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtBaryonPCRFF.\n";  
  ::abort();
...
void EvtBaryonPCRFF::gettensorff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtBaryonPCRFF.\n";  
  ::abort();
...
void EvtBaryonPCRFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtBaryonPCRFF.\n";  
  ::abort();
