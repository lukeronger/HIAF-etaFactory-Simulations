{
	...
	cout<<data->Draw("Particles.TLorentzVector.Pt():Particles.TLorentzVector.Theta()*TMath::RadToDeg()>>h(200,0,180,200,0,0.5)","Particles.pid==8","colz")<<endl;
...
//	li->Draw();
	...
	h->GetYaxis()->SetTitle("P_{t}^{#pi^{#pm}} (GeV/c)");
