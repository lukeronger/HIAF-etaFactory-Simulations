...
!
! COPYRIGHT
! (C) 2005-2018 The GiBUU Team (see full list of authors below)
!
...
contains
  ...
  subroutine initConfig(energyRaiseFlag)
    ...
    case (ExternalSource)
       ...
       if(targetNuc%mass.ge.1)  call setUpTarget()

       call initializeExternal(realParticles,pertParticles,targetNuc)
