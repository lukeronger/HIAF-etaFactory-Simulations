...
// ------   Constructor   --------------------------------------------------
ChnsFieldPar::ChnsFieldPar(const char* name, const char* title, const char* context)
...
// ------   Put parameters   -----------------------------------------------
void ChnsFieldPar::putParams(FairParamList* list)
{
...
// --------   Get parameters   ---------------------------------------------
Bool_t ChnsFieldPar::getParams(FairParamList* list)
{
...
void ChnsFieldPar::SetParameters(FairField* field)
{

    if (!field) {
        cerr << "-W- ChnsFieldPar::SetParameters: Empty field pointer!" << endl;
        return;
    }
    ...
    if (fType == 0) {   // constant field
        ChnsConstField* fieldConst = (ChnsConstField*)field;
        ...
        cerr << "-W- ChnsFieldPar::SetParameters: Unknown field type " << fType << "!" << endl;
        fBx = fBy = fBz = 0.;
