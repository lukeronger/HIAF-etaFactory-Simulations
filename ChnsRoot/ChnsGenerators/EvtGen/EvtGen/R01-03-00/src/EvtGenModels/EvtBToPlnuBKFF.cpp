...
void EvtBToPlnuBKFF::getvectorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtBToPlnuBKFF.\n";  
  ::abort();
...
void EvtBToPlnuBKFF::gettensorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtBToPlnuBKFf.\n";  
  ::abort();
...
void EvtBToPlnuBKFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtBToPlnuBKFF.\n";  
  ::abort();
...
void EvtBToPlnuBKFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtBToPlnuBKFF.\n";
  ::abort();
...
void EvtBToPlnuBKFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtBToPlnuBKFF.\n";
  ::abort();
