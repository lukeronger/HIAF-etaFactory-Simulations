...
void EvtBsquark::decay(EvtParticle *p){
  ...
  //report(EVT_INFO,"EvtGen") <<g<<" "<<V11<<" "<<FL<<" "<<vcsb<<" "<<mchi1<<endl;
  //report(EVT_INFO,"EvtGen") << "f1:"<<f1<<" "<<(p4b-p4c).mass2()<<endl;
  //report(EVT_INFO,"EvtGen") << "f2:"<<f2<<" "<<(p4b-p4c).mass2()<<endl;

  //report(EVT_INFO,"EvtGen") << "p4sn:"<<p4sn<<endl;
  ...
  //report(EVT_INFO,"EvtGen") << "pslash:"<<pslash<<endl;
  ...
  for(il=0;il<2;il++){
	...
	b=lepton->spParent(il)*((pslash*PR)*charmquark.spParent(ic));
      ...
      //report(EVT_INFO,"EvtGen") <<"pslash*PR:"<<pslash*PR<<endl;
      //report(EVT_INFO,"EvtGen") <<"sp charm:"<<charmquark.spParent(ic)<<endl;
      //report(EVT_INFO,"EvtGen") <<"sp lepton:"<<lepton->spParent(il)<<endl;

      M[ic][il]=f1*(a1*a+b1*b)+f2*(a2*a+b2*b);

      //report(EVT_INFO,"EvtGen") << "Contr1:"<<a1<<" "<<a<<" "<<b1<<" "<<b<<endl;
      //report(EVT_INFO,"EvtGen") << "Contr2:"<<a2<<" "<<a<<" "<<b2<<" "<<b<<endl;

      //report(EVT_INFO,"EvtGen") <<"case1:"<<f1<<" "<<a1<<" "<<b1<<" "<<a<<" "<<b<<endl;
      //report(EVT_INFO,"EvtGen") <<"case2:"<<f2<<" "<<a2<<" "<<b2<<" "<<a<<" "<<b<<endl;
  ...
  //report(EVT_INFO,"EvtGen") <<"prob:"<<prob<<endl;
