...
#ifndef PlutoEta2evt_h
#define PlutoEta2evt_h
...
class PlutoEta2evt : public TSelector {
public :
   ...
   PlutoEta2evt(TTree * /*tree*/ =0) { }
   virtual ~PlutoEta2evt() { }
   ...
   ClassDef(PlutoEta2evt,0);

};

#endif

#ifdef PlutoEta2evt_cxx
void PlutoEta2evt::Init(TTree *tree)
{
