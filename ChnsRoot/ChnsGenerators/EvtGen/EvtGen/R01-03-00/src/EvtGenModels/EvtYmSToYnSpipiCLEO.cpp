...
void EvtYmSToYnSpipiCLEO::init(){
  ...
  if ((!(getDaug(1)==PIP&&getDaug(2)==PIM))&&
    ...
    report(EVT_ERROR,"EvtGen") << "EvtYmSToYnSpipiCLEO generator expected "
...
// //   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "M_nS = " << v->getP4().mass() << endl;
  ...
  while( false == acceptX ) 
    {
      ...
      //   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "m_X = " << mX << endl;
	...
	costheta = - p4[1].dot(P_YmS_X)/(p4[1].d3mag()*P_YmS_X.d3mag());
      ...
      // //   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "cos(theta) = " << costheta << endl;
...
//   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "M_nS = " << v->getP4().mass() << endl;
//   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "m_pi = " << s1->getP4().mass() << endl;
//   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "m_pi = " << s2->getP4().mass() << endl;
//   report(EVT_INFO,"EvtYmSToYnSpipiCLEO")  << "M2 = "   << M2 << endl;
