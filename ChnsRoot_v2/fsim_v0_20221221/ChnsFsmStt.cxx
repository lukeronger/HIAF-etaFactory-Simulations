...
ChnsFsmStt::ChnsFsmStt(ArgList &par) 
{
  initParameters();
...
ChnsFsmResponse* 
ChnsFsmStt::respond(ChnsFsmTrack *t)
{
...
double
ChnsFsmStt::gauss(double x, double x0, double s)
{
...
double 
ChnsFsmStt::compdEdx(double p, double M)
{
  double dEdX;
...
bool 
ChnsFsmStt::detected(ChnsFsmTrack *t) const
{
  if (t->hitMapValid()) {
...
double 
ChnsFsmStt::dp(ChnsFsmTrack *t) const
{
  ...
  //double cont1 = 0.3*sqrt(720.0/(_n+4))*_sigXY*mom*sin(theta)/(_Bfield*_Lpath*_Lpath);  //comment out at 11.22 2018
  double cont1 = sqrt(720.0/(_n+4))*_sigXY*mom*sin(theta)/(0.3*_Bfield*_Lpath*_Lpath);  //modified by Yutie Liang at 11.22 2018
  //double cont2 = 5.23e-2/(_Bfield*beta*sqrt(_Lpath*_X0*sin(theta)));   //comment out by Yutie at 11.22 2018    change _X0 to L/_X0 = 0.02 : 2% radiation length
  double cont2 = 5.23e-2/(_Bfield*beta*sqrt(_Lpath*_Lpath/_X0*sin(theta)));  //_X0 is defined at X/X0 the number of radiation length . (~ 2% for tpc)
  double cont3 = _sigTht/tan(theta);
  return ( sqrt(cont1*cont1 + cont2*cont2 + cont3*cont3) * mom );
}

double
ChnsFsmStt::dphi(ChnsFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
  return 0.0007; //to be refined
}

double
ChnsFsmStt::dtheta(ChnsFsmTrack *) const // t //[R.K.03/2017] unused variable(s)
{
  return 0.0007; //to be refined
}

void
ChnsFsmStt::print(ostream &o)
{
...
bool
ChnsFsmStt::setParameter(std::string &name, double value)
{
  // *****************
