...
#ifndef ChnsConstField_H
#define ChnsConstField_H 1

#include "FairField.h"

class ChnsFieldPar;

class ChnsConstField : public FairField
{
  ...
  public:
     ...
     **/
    ChnsConstField(const char* name,
                 Double_t xMin,
                 Double_t xMax,
                 Double_t yMin,
                 Double_t yMax,
    ...
    ChnsConstField(ChnsFieldPar* fieldPar);

    /** Destructor **/
    virtual ~ChnsConstField();
