...
void MakeROOTFile(string filename){
	...
	tree = new TTree("tree","selection of pi+ pi- gamma1 gamma2");
...
void analyze_pdTo3HeEta_3piChannel_GiBUU()
{
	// Number of events
	...
	t->Add("/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/fsim_GiBUU_pd_collision_part1_1.8GeV_2023.root");
	t->Add("/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/fsim_GiBUU_pd_collision_part2_1.8GeV_2023.root");
	t->Add("/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/fsim_GiBUU_pd_collision_part3_1.8GeV_2023.root");
	t->Add("/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/fsim_GiBUU_pd_collision_part4_1.8GeV_2023.root");
	t->Add("/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/fsim_GiBUU_pd_collision_part5_1.8GeV_2023.root");

	/// Set the output file and directory
	string output_file = "../../../HIAF-etaFactory-Simulations-localData/ChnsRoot-data/HIAF-pdTo3HeEta-3piChannel-GiBUU-fsim.root";
...
//		cout<<"Nneutral_tracks="<<fNeuts->GetEntriesFast()<<endl;
		...
		// fill the TTree file
		if(Npim_MC>=1  &&  Npip_MC>=1  &&  Ngamma_MC>=2) tree->Fill();
