...
// from the arguements.
   ...
   if ( numSLPoleargs !=8 ) {
     report(EVT_ERROR,"EvtGen") << "Problem in EvtSLPoleFF::getscalarff\n";
 ...
 void EvtSLPoleFF::getvectorff(EvtId parent,EvtId,
  ...
  if ( numSLPoleargs !=16 ) {
     report(EVT_ERROR,"EvtGen") << "Problem in EvtSLPoleFF::getvectorff\n";
     report(EVT_ERROR,"EvtGen") << "wrong number of arguements!!!\n";
     report(EVT_ERROR,"EvtGen") << numSLPoleargs<<"\n";
  }
 ...
 void EvtSLPoleFF::gettensorff(EvtId parent,EvtId,
  ...
  if ( numSLPoleargs !=16 ) {
     report(EVT_ERROR,"EvtGen") << "Problem in EvtSLPoleFF::gettensorff\n";
     report(EVT_ERROR,"EvtGen") << "wrong number of arguements!!!\n";
  }
...
void EvtSLPoleFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtSLPoleFF.\n";  
  ::abort();
...
void EvtSLPoleFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtSLPoleFF.\n";
  ::abort();
...
void EvtSLPoleFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtSLPoleFF.\n";
  ::abort();
