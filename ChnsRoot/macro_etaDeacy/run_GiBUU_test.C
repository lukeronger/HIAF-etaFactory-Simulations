...
int run_GiBUU_test(int nevts=900, int seed_num = 2023)
{
  TString input_file = "/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/GiBUU-data-evt/GiBUU_final_states-pLi7-test.evt";
  ...
  TString outfile;
  if (outfile=="") {
	outfile="/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/run_fsim_EvtGen_GiBUU_test__"; //1.root";
	outfile+=1.8;
	outfile+="GeV_";
  	outfile+= seed_num;
	outfile+=".root";
