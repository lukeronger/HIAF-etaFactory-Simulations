...
void EvtKKLambdaCFF::getscalarff(EvtId, EvtId,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getscalarff in EvtKKLambdaCFF.\n";  
  ::abort();
...
void EvtKKLambdaCFF::getvectorff(EvtId, EvtId,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getvectorff in EvtKKLambdaCFF.\n";  
  ::abort();
...
void EvtKKLambdaCFF::gettensorff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :gettensorff in EvtKKLambdaCFF.\n";  
  ::abort();
...
void EvtKKLambdaCFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtKKLambdaCFF.\n";
  ::abort();
...
void EvtKKLambdaCFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtKKLambdaCFF.\n";
  ::abort();
