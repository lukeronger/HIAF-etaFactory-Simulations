...
int run_GiBUU_final_state_particles_part1(int nevts=4800000, int seed_num = 2023)
{
  ...
  TString outfile;
  if (outfile=="") {
	outfile="/public/hep3/rwang/HIAF-etaFactory-Simulations-localData3/ChnsRoot_v2-data/run_fsim_EvtGen_GiBUU_final_state_particles_part8_"; //1.root";
