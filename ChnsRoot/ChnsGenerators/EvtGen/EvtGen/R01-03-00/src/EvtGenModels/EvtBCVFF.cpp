...
void EvtBCVFF::getvectorff(EvtId,EvtId,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtBCVFF.\n";  
    ::abort();
  };
}
...
void EvtBCVFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtBCVFF.\n";
  ::abort();
...
void EvtBCVFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtBCVFF.\n";
  ::abort();
