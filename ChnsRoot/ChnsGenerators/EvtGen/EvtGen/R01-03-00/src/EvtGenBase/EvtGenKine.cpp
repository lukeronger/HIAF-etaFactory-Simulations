  ...
  if ( ndaug != 2 ) {
    ...
    int il2=0;
     ...
     case 15:
       ...
       break;
     default:
       report(EVT_ERROR,"EvtGen") << "too many daughters for phase space..." << ndaug << " "<< mp <<endl;;
       break;
     }
	 ...
	 wt=wt*EvtPawt(pm[4][il-1],pm[4][il+1-1],mass[il-1]);
       ...
       if (wt>wtmax) {
	 report(EVT_ERROR,"EvtGen") << "wtmax to small in EvtPhaseSpace with "
...

{
  ...
  //report(EVT_INFO,"EvtGen") << m13sq << endl;
  //report(EVT_INFO,"EvtGen") << m12sq << endl;
  //report(EVT_INFO,"EvtGen") << E1 << endl;
  //report(EVT_INFO,"EvtGen") << E2 << endl;
  //report(EVT_INFO,"EvtGen") << E3 << endl;
  //report(EVT_INFO,"EvtGen") << p1mom << endl;
  //report(EVT_INFO,"EvtGen") << p3mom << endl;
  //report(EVT_INFO,"EvtGen") << cost13 << endl;
  ...
  //report(EVT_INFO,"EvtGen") << "p4:"<<p4[0]<<p4[1]<<p4[2]<<endl;
