...
ClassImp ( RhoSimpleProtonSelector )

TBuffer& operator>> ( TBuffer& buf,RhoSimpleProtonSelector  *&obj )
{
  obj = ( RhoSimpleProtonSelector* ) buf.ReadObject ( RhoSimpleProtonSelector::Class() );
  return buf;
}

RhoSimpleProtonSelector::RhoSimpleProtonSelector ( const char* name, const char* type ) :
