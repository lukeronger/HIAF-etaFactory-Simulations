...
// from the arguments.
   ...
   if ( numSLBKPoleargs != 4 ) {//modified
     report(EVT_ERROR,"EvtGen") << "Problem in EvtSLBKPoleFF::getscalarff\n";
     report(EVT_ERROR,"EvtGen") << "wrong number of arguments!\n";
     report(EVT_ERROR,"EvtGen") << "number args:"<<numSLBKPoleargs<<" (expected 4)\n";
     report(EVT_ERROR,"EvtGen") << "Parent:"<<EvtPDL::name(parent)<<"\n";
     report(EVT_ERROR,"EvtGen") << "Daughter:"<<EvtPDL::name(daught)<<"\n";
...
void EvtSLBKPoleFF::getvectorff(EvtId parent,EvtId /*daught*/,
   ...
   if ( numSLBKPoleargs !=8 ) {//modified
     report(EVT_ERROR,"EvtGen") << "Problem in EvtSLBKPoleFF::getvectorff\n";//modified
     report(EVT_ERROR,"EvtGen") << "wrong number of arguements!!!\n";
     report(EVT_ERROR,"EvtGen") << numSLBKPoleargs<<"\n";//modified
//     printf("\n*********************%d*********************",numSLBKPoleargs);
  }


   report(EVT_INFO,"EvtGen")<<"Check the implementation of EvtSLBKPoleFF::getvectorff()!\n";
...
void EvtSLBKPoleFF::gettensorff(EvtId parent,EvtId /*daught*/,
  ...
  if ( numSLBKPoleargs !=16 ) {
     report(EVT_ERROR,"EvtGen") << "Problem in EvtSLBKPoleFF::gettensorff\n";
     report(EVT_ERROR,"EvtGen") << "wrong number of arguements!!!\n";
  }

  report(EVT_INFO,"EvtGen")<<"Check the implementation of EvtSLBKPoleFF::gettensorff()!\n";
...
void EvtSLBKPoleFF::getbaryonff(EvtId, EvtId, double, double, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getbaryonff in EvtSLBKPoleFF.\n";  
  ::abort();
...
void EvtSLBKPoleFF::getdiracff(EvtId, EvtId, double, double, double*, double*,
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getdiracff in EvtSLBKPoleFF.\n";
  ::abort();
...
void EvtSLBKPoleFF::getraritaff(EvtId, EvtId, double, double, double*, double*, 
  ...
  report(EVT_ERROR,"EvtGen") << "Not implemented :getraritaff in EvtSLBKPoleFF.\n";
  ::abort();
