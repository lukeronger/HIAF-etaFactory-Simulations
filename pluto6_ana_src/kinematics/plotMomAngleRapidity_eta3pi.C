{
	...
	c1.cd(1);
	data->Draw("Particles.TLorentzVector.P()>>h(100,0,1)","Particles.pid==1","",2000000);
	data->Draw("Particles.TLorentzVector.P()>>hh(100,0,1)","Particles.pid==8","same",2000000);
	hh->SetLineColor(4);
	h->SetLineColor(2);
	hh->SetLineWidth(2);
	h->SetLineWidth(2);
	...
	data->Draw("Particles.TLorentzVector.Theta()*TMath::RadToDeg()>>hh2(100,0,180)","Particles.pid==8","same",2000000);
	hh2->SetLineColor(4);
	h2->SetLineColor(2);
	hh2->SetLineWidth(2);
	h2->SetLineWidth(2);
	...
	data->Draw("Particles.TLorentzVector.Eta()>>hh3(100,-5,7)","Particles.pid==8","same",2000000);
	hh3->SetLineColor(4);
	h3->SetLineColor(2);
	hh3->SetLineWidth(2);
	h3->SetLineWidth(2);
