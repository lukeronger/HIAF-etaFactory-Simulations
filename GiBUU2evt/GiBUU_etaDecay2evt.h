...
#ifndef GiBUU_etaDecay2evt_h
#define GiBUU_etaDecay2evt_h
...
class GiBUU_etaDecay2evt : public TSelector {
public :
   ...
   GiBUU_etaDecay2evt(TTree * /*tree*/ =0) { }
   virtual ~GiBUU_etaDecay2evt() { }
...
#ifdef GiBUU_etaDecay2evt_cxx
void GiBUU_etaDecay2evt::Init(TTree *tree)
{
...
Bool_t GiBUU_etaDecay2evt::Notify()
{
...
#endif // #ifdef GiBUU_etaDecay2evt_cxx
