...
// Tue Jun  4 11:50:37 2024 by ROOT version 6.18/04
...
class select_3pi : public TSelector {
public :
   ...
   ClassDef(select_3pi,0);


   TFile *file_out;
   TH1F *hmass_gg;
   TH1F *hmass_pippimpi0;
   TH2F *heta_PTheta;
   TH2F *h3He_PTheta;
...
#ifdef select_3pi_cxx
void select_3pi::Init(TTree *tree)
{
