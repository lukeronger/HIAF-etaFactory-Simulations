...
int run_UserDefined_neutrons(int nevts=1000000, int seed_num = 2023)
{
  TString input_file = "../../../HIAF-etaFactory-Simulations-localData/evt_files/user-defined-neutrons.evt";
  ...
  TString outfile;
  if (outfile=="") {
	outfile="/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/run_fsim_EvtGen_UserDefined_neutrons_"; //1.root";
	outfile+=1.8;
	outfile+="GeV_";
  	outfile+= seed_num;
	outfile+=".root";
