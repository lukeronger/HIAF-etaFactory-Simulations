...
int run_sample_cpy(int nevts=10000000, int seed_num = 2023)
//int run_etaDecay(int nevts=372, int seed_num = 2023)
{
  TString input_file = "/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/Pluto6-evt/pp_to_ppeta_PipPimPi0_mDarkHiggs0.4_1.8GeV_Random2023.root.evt"; 
  ...
  TString outfile;
  if (outfile=="") {
	outfile="/data/rwang/simulation_works/HIAF-etaFactory-Simulations-localData2/ChnsRoot-data/run_fsim_EvtGen_HIAFeta_PipPimPi0_mDarkHiggs0.4_"; //1.root";
	outfile+=1.8;
	outfile+="GeV_";
  	outfile+= seed_num;
	outfile+=".root";
...
*/
  ...
  fastSim->AddDetector("EmcBarrel","efficiency=1.0");
