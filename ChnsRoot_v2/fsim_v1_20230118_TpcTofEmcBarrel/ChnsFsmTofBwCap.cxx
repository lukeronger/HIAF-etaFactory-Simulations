...
//      $Id: FsmTofBwCap.cc,v 1.2 2018/11/16 16:22:00 YutieLiang Exp $
//
// Description:
//      Class FsmTofBwCap
//      
...
ChnsFsmTofBwCap::ChnsFsmTofBwCap() 
{
  initParameters();
...
ChnsFsmTofBwCap::ChnsFsmTofBwCap(ArgList &par) 
{
  initParameters();
...
ChnsFsmResponse* 
ChnsFsmTofBwCap::respond(ChnsFsmTrack *t)
{
...
double
ChnsFsmTofBwCap::gauss_t(double x, double x0, double s)
{
...
bool 
ChnsFsmTofBwCap::detected(ChnsFsmTrack *t) const
{
  if (t->hitMapValid()) {
...
void
ChnsFsmTofBwCap::print(ostream &o)
{
...
void 
ChnsFsmTofBwCap::initParameters()
{
...
bool
ChnsFsmTofBwCap::setParameter(std::string &name, double value)
{
  // *****************
