...
//      $Id: ChnsFsmSttPid.cc,v 1.13 2007/05/24 08:07:40 klausg Exp $
//
// Description:
//      Class ChnsFsmSttPid
//
...
ChnsFsmSttPid::ChnsFsmSttPid(ArgList &par)
{
  initParameters();
...
ChnsFsmResponse*
ChnsFsmSttPid::respond(ChnsFsmTrack *t)
{
...
double
ChnsFsmSttPid::gauss(double x, double x0, double s)
{
...
double
ChnsFsmSttPid::compdEdx(double p, double M)
{
  double dEdX;
...
bool
ChnsFsmSttPid::detected(ChnsFsmTrack *t) const
{
...
bool
ChnsFsmSttPid::setParameter(std::string &name, double value)
{
  // *****************
